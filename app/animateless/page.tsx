...
const buttonStyle =
    'text-white text-2xl sm:text-3xl border border-indigo-950 rounded bg-slate-600 py-2 px-8 w-full';
...
const page = () => {
    ...
    return (
        <div className="bg-stone-400 ">
            ...
            <div className="flex flex-wrap w-full justify-around items-center gap-4">
